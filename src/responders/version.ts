...
export const handle = (m: Message): void => {
	...
	Promise.all([seatdocker, api, seat_console, eveapi, notifications, services, web])
		.then(function(values)
		{
			...
			.addFields(
			    [name:`\u200B`, value: `Seat Docker - [${values[0]}](https://hub.docker.com/r/eveseat/seat)`],
			    [name:`\u200B`, value: `API - [${values[1]}](https://github.com/eveseat/api/releases/latest)`],
			    [name:`\u200B`, value: `Console (Depreciated) - [${values[2]}](https://github.com/eveseat/api/releases/latest)`],
			    [name:`\u200B`, value: `EveAPI - [${values[3]}](https://github.com/eveseat/api/releases/latest)`],
			    [name:`\u200B`, value: `Notifications - [${values[4]}](https://github.com/eveseat/api/releases/latest)`],
			    [name:`\u200B`, value: `Services - [${values[5]}](https://github.com/eveseat/api/releases/latest)`],
			    [name:`\u200B`, value: `Web - [${values[6]}](https://github.com/eveseat/api/releases/latest)`],
			);
